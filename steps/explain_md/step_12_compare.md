Cycles are useful to keep track of KPI over time. The goal of the code below is to compare the primary scenarios of every cycle and their pipelines in time.
